...
module OpenapiClient
  class Limits
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Limits`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] chats Value to be assigned
    def chats=(chats)
      if chats.nil?
        fail ArgumentError, 'chats cannot be nil'
      end
    ...
    def hash
      [messages, chats, checks, requests].hash
    end
